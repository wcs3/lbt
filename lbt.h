...
/**
 * @brief Transform an array of arbitrary type to a
 ...
 *
 * User provides a callback to the function that compares
 ...
 *
 * @return pointer to node with search key if it exists in
 * the btree, NULL if not.
 */
